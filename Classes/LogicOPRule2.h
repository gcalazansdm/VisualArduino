...
class LogicOPRule2 : public LogicOP
{
	...
	public:
		...
		LogicOPRule2(const LogicOPRule2& logicoprule2):LogicOP(logicoprule2),unitarylogicaloperator_(logicoprule2.unitarylogicaloperator_),logicop_(logicoprule2.logicop_){}//olá
